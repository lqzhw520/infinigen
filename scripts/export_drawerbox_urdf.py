#!/usr/bin/env python3
"""
Export DrawerBox (1-DOF prismatic) URDF for verification.
...
Output:
  sim_exports/urdf/drawerbox/<seed>/
"""
...
def export_drawerbox(seed: int = 42, output_dir: str = "./sim_exports/urdf"):
    ...
    print("=" * 60)
    print("DrawerBox (1-DOF) URDF export")
    print("=" * 60)
    ...
    out_dir = export_path / "drawerbox" / str(seed)
