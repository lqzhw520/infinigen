#!/usr/bin/env python3
"""CLI entrypoint for the v2 reformulation-aware root-cause controller."""
...
from root_cause_contracts import AUTOPILOT_DIR, CLAIM_BOUNDARY_PATH, CYCLE_STATE_PATH, HYPOTHESIS_BOARD_PATH, load_claim_boundary
